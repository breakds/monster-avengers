...
#include <string>
#include "dataset/base/data_util.h"
...
namespace monster_avengers {
  ...
  namespace dataset {
    ...
    template <>
    EnumStringTable<WeaponType> {
      static const std::Array<std::string, 3> names;
    };
    EnumStringTable<WeaponType>::names = {"melee", "range", "both"};
    ...
    template <>
    EnumStringTable<ArmorPart> {
      static const std::Array<std::string, 7> names;
    };
    EnumStringTable<ArmorPart>::names = {
    ...
    template <>
    EnumStringTable<Gender> {
      static const std::Array<std::string, 3> names;
    };
    EnumStringTable<Gender>::names = {
      "male", "female", "both"};
