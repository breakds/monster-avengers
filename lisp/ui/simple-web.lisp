...
(def-widget armor-display (part armor)
  ...
  #jsx(:tr ()
           ...
           (:td ((style :text-align "center")) 
                ...
                (when (and (local-state expanded)
                           ...
                           (not (= part "amulet")))
                  (:div ((class-name "row"))
                        (:div ((class-name "well well-sm col-md-offset-3 col-md-6"))
                              (:button ((class-name "btn btn-default btn-xs"))
...
(def-widget tab-panel (pages callback active-page)
    ()
...
(def-widget app-view ()
    ((state (language "en")
            ...
            ;; (amulets (array))
	    ;; (effects (array))
            (amulets (array (array 2 39 4)))
            (effects (array (create :id 39
                                    :active 0
                                    :points 10)
                            (create :id 40
                                    :active 1
  ...
  #jsx(:div ((style :margin "20px 50px 30px 50px"))
            ...
            (:tab-panel ((pages (array "search" "result"))
